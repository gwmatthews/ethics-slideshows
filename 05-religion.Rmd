...
- Religion not only offers and account of the origins of human laws, but of the natural order of things in general.
...
- Would could discover the fundamental principles of ethics and how to implement them by relying on our innate capacity to reason.
...
- This view emphasizes hierarchy in nature, which we may doubt really exists.
...
The second requires another slide.
...
- Since this is a morally loaded idea, it must in some way depend on our choices -- we longer take it for granted that there is a natural order of things in the universe that dictates right and wrong as Aquinas and Aristotle once did.
...
- Historicially speaking cultures often express ethical concepts in religious terms and so religion *seems* to come first.
...
- They are independent of "human nature," whatever it actually means.
