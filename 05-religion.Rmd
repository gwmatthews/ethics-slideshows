...
![:scale 80%, #222;](img/05/aristotle.jpg)
...
3. **Efficient cause:** What led to its current state? 
...
Aristotle provided the foundation for the ancient and medieval view of the natural world as a *hierarchical order* where everything has its proper place,  causes and functions.
]

---
.right-column[

.topcap[How does this apply to human beings?]
...
.argument[
1. We are made of flesh and blood.
2. We are rational and political animals.
3. Our parents are the cause of our being as we are.
4. Our function is to realize our natures, to attain true happiness through virtuous behavior.
]
]
...
![:scale 40%, #222;](img/05/valtercirillo-paestum-1.jpg)
...
![:scale 80%, #222;](img/05/aquinas.jpg)
...
Aquinas took Aristotle's account of the order of nature and "Christianized" it, placing God at the top of the "Great Chain of Being." 
...
All of this is based on the idea that the universe was created by God for a purpose, with us at the center of things.
...
The first brings up a long and involved debate about what is innate in human beings and what is learned or a product of our environments. It is far from clear...

--

What exactly do we mean by nature here? See next slides...

---
layout: true
### *Is it wrong to go against nature?*
...
$1$. What follows the Laws of Nature is better than what doesn't. 
...
- So in this sense it is .red[FALSE] that what is unnatural is wrong.

---

.argument[

$2$. What is statistically uncommon is not natural and this is worse than what isn't. 
...
$3$ What is artificial is unnatural and what is not artificial is both natural and inherently better. 
...
$4$. What violates natural functions is unnatural and wrong. 
...
- So once again it is .red[FALSE] that what is unnatural is automatically wrong.

---
layout: false

### *Which comes first ethics or religion?*
...
[Religion and Morality](https://plato.stanford.edu/entries/religion-morality/): a comprehensive account of the long and complex interactions between these two important aspects of human culture at the *Stanford Encyclopedia of Philosophy*.

[Crash course video: Divine Command Theory](https://youtu.be/wRHBwxC8b8I): Hank Green's account is short succinct and to the point.

[Crash Course video: Natural Law Theory](https://youtu.be/r_UfYY7aWKo): another great video.

[Can We Have Ethics Without Religion?](https://press.rebus.community/intro-to-phil-ethics/chapter/can-we-have-ethics-without-religion-on-divine-command-theory-and-natural-law-theory/), Jeffrey Morgan. Another helpful overview of the complex issues here from the *Introduction to Philosophy: Ethics* textbook.

---
class: center credits

![:scale 50%, #222;](img/05/valtercirillo-paestum-2.jpg)
...
[Peter H](https://pixabay.com/users/tama66-1032521/) and [Valter Cirillo](https://pixabay.com/users/valtercirillo-3274677/) at Pixabay
