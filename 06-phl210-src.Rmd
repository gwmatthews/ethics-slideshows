...
![:portrait Adam Smith, 1723-1790, 80%](img/06/adam-smith.jpg)
...
![:portrait Ayn Rand, 1905-1982, 80%](img/06/rand.jpg)
...
- Rand simply assumes that the pursuit of happiness is a *zero sum game* --  gain requires your loss and vice-versa.
...
![:jump Egoism](https://plato.stanford.edu/entries/egoism/): a comprehensive account from the Stanford Encyclopedia of Philosophy.

![:jump What's in it for me?](https://press.rebus.community/intro-to-phil-ethics/chapter/whats-in-it-for-me-on-egoism-and-social-contract-theory/), Ya-Yun (Sherry) Kao, in *Introduction to Philosophy: Ethics.* This chapter covers Egoism as well as our next theory, Social Contract Theory.

![:jump Inequality in The USA](https://youtu.be/QPKKQnijnsM): a great video on what Americans want in terms of wealth distribution, our perception of what it is, and the reality. It turns out to be different than you might think.

![:jump The New Age of Ayn Rand:](https://www.theguardian.com/books/2017/apr/10/new-age-ayn-rand-conquered-trump-white-house-silicon-valley) decades after her death her fiction continues to have an outsized influence on American public life. Read more in this article from the British news site *The Guardian*.
...
![:jump Quentin Jouvray](https://pixabay.com/users/jinkyr-6852513/) and ![:jump Michael Gaida](https://pixabay.com/users/michaelgaida-652234/) at Pixabay
