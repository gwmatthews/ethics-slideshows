...
#### [fallacies of relevance](#22)

#### .fade-out[[fallacies of ambiguity](#41)]

#### .fade-out[[fallacies of presumption](#50)]
#### .fade-out[[hot biases](#67)]

#### .fade-out[[cold biases](#74)]

]

---

### .center[*Fallacies of relevance*]

.right-list[
.caution[

- Jump to conclusions based on inadequate evidence.

- Appeal to irrelevant details.

- Rely on our tendency to see lots of connections even when they are not as strong as they seem.
]
]
...
#### .fade-out[[fallacies of relevance](#22)]
...
### .center[*Fallacies of ambiguity*]

.right-list[
.caution[

- Rely on shifting and playing around with the meanings of words.

- Some terms are vague, and some have multiple and conflicting meanings.
...
### .center[*Fallacy of misplaced concreteness*]
...
People often talk about such abstract entities as "the government," "the media," or "society" as if they were concrete things that *could* attempt to control us or do other nefarious things. In reality governments, the media and society are collections of particular individuals. They *might* coordinate their efforts, but then most groups are made of individuals with different ideas and interests -- good old "office politics." Reality is much messier than simple abstract nouns like these suggest.
...
### .center[*Fallacies of presumption*]

.right-list[
.caution[

- Rest on implied but unacknowledged assumptions.

- Stretch the evidence too far.

- Depend on our willingness to fill in the blanks and rely on mental shortcuts.
]
]
...
While many people trust eyewitness testimony, the question here is how someone might *know* that what they saw really was a ghost. This would require accepting the assumption that ghosts do exist, but isn't that what the argument is claiming to prove?
...
Conspiracy theories often rely on appeals to ignorance like this. They shift the "burden of proof" to someone opposing their viewpoint without providing sufficient evidence to prove their claims to be correct.
...
Isn't a better explanation here that after playing either better or worse than average, the team typically returns to their *average* performace? 
...
- Also known as "motivated irrationality."

- Result from the fact that our emotional and personal lives influence what we want to accept.

- What we want can influence what we are willing and able to see.
]
]
...
- Also known as "unmotivated irrationality."

- Result from "bugs" in our mental operating systems.

- The mental shortcuts that we rely on don't always work so well in certain contexts.
]
]
