...
![:portrait Aristotle, 384-322 BCE, 80%](img/05/aristotle.jpg)
...
![:portrait St Thomas Aquinas, 1225-1274, 80%](img/05/aquinas.jpg)
...
![:jump Religion and Morality](https://plato.stanford.edu/entries/religion-morality/): a comprehensive account of the long and complex interactions between these two important aspects of human culture at the *Stanford Encyclopedia of Philosophy*.

![:jump Crash course video: Divine Command Theory](https://youtu.be/wRHBwxC8b8I): Hank Green's account is short succinct and to the point.

![:jump Crash Course video: Natural Law Theory](https://youtu.be/r_UfYY7aWKo): another great video.

![:jump Can We Have Ethics Without Religion?](https://press.rebus.community/intro-to-phil-ethics/chapter/can-we-have-ethics-without-religion-on-divine-command-theory-and-natural-law-theory/), Jeffrey Morgan. Another helpful overview of the complex issues here from the *Introduction to Philosophy: Ethics* textbook.
...
[download this presentation](./pdf/05-phl210-slides.pdf) or [print it](./pdf/05-phl210-handout.pdf)
