...
- Makes certain .fade-in[assumptions]: we have to start *somewhere*.

--

- Has .fade-in[implications]: *if it is true*, then we have to accept other stuff too.

--

- Requires support in an .fade-in[argument]: none are *obvious* even if they might seem believable at first glance.
...
[download this presentation](./pdf/04-relativism.pdf) or [print it](./pdf/04-relativism-print.pdf)
