...
.myright-column[
The majority of course might be wrong, no matter how numerous there are. This is why democratic societies are not only based on the principle that the majority gets to decide but instead we all have rights that protect us from the majority.
]
...
This is a debating trick that fails to address the topic at hand in the interest of scoring points with the audience. It may be tempting to paraphrase y opponent's viewpoint, but be careful not to misrepresent it!
...
Alarmist claims about what *will* happen as a result of doing something or other are hard to avoid since we do tend to think of worst case scenarios. In this case, since a clone is nothing but an artificially produced *twin,* raising a clone for its parts would be illegal and immoral?
...
Thus negative reinforcement works, and positive reinforcement does not work.
...
Isn't a better explanation here that after playing either better or worse than average, the team returns to their average? This is a classic case of confusing correlation with causation.
...
Circular reasoning is like the question of which came first the chicken or the egg? Which explains which according to this argument: does mental illness explain mass-murder or does mass murder prove mental illness? In either case no evidence is here presented.
...
[Your Logical Fallacy Is](https://yourlogicalfallacyis.com/): A well designed website with good examples of a variety of fallacies.

[Your Bias Is](https://yourbias.is/): By the creators of Your Logical Fallacy Is, this site is devoted to some important cognitive biases.

[Logically Fallacious](https://www.logicallyfallacious.com/tools/lp/Bo/LogicalFallacies): a comprehensive list of hundereds of types of fallacies and biases.

[Fallacies](https://www.iep.utm.edu/fallacy/): The Internet Encyclopedia page on logical fallacies has another comprehensive list.
